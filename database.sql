...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2021 at 01:37 PM
...
ALTER TABLE `detail_order`
  ADD PRIMARY KEY (`id_detail_order`,`id_order`,`id_menu`),
  ADD KEY `FKdetail_ord790250` (`id_order`),
...
ALTER TABLE `detail_order`
  ...
  ADD CONSTRAINT `FKdetail_ord790250` FOREIGN KEY (`id_order`) REFERENCES `order` (`id_order`);
